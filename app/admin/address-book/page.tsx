...
export default function AddressBookPage() {
  ...
  function startEdit(p: any) {
    setEditingId(p.id)
    setEditForm({
      name: p.name || '', furigana: p.furigana || '', phone: p.phone || '',
      birth_date: p.birth_date || '', address: p.address || '',
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <div>
                  ...
                  <input className="input-field" value={editForm.furigana} placeholder="やまだ たろう"
              ...
              <div>
                ...
                <input className="input-field" placeholder="例：常連さん・マダイ好き" value={editForm.memo}
              ...
              <div className="flex items-start justify-between mb-2">
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex flex-wrap gap-1 mt-1">
                    {p.line_user_id && (
                      <span className="text-xs text-green-600 bg-green-50 border border-green-200 px-1.5 py-0.5 rounded-full">💬 LINE連携</span>
                    )}
                    {p.memo && (
                      <span className="text-xs text-gold-700 bg-gold-50 border border-gold-200 px-1.5 py-0.5 rounded-full">📝 {p.memo}</span>
                    )}
                  </div>
                </div>
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <div>
                ...
                <input className="input-field" placeholder="やまだ たろう"
                  value={addForm.furigana} onChange={e => setAddForm({ ...addForm, furigana: e.target.value })} />
              </div>
            </div>
            <div>
